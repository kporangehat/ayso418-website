...
def rename_hero_block_to_cta_text(apps, schema_editor):
    """
    Rename 'hero' block type to 'cta_text' in HomePage body StreamField.
    """
    ...
    for page in HomePage.objects.all():
        if page.body:
            ...
            try:
                ...
                print(f"Skipping HomePage {page.id}: {e}")
                continue
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0027_alter_hero_image_alter_hero_image_layout_and_more'),
    ]
